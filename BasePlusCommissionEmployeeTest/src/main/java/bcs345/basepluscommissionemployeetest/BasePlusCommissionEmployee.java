...
public class BasePlusCommissionEmployee {
   ...
   // return first name
    public String getFirstName() {return cE.getFirstName();}
   // return last name
   public String getLastName() {return cE.getLastName();}
   // return social security number 
   public String getSocialSecurityNumber() {return cE.getSocialSecurityNumber();}
   // return gross sales amount
   public double getGrossSales() {return cE.getGrossSales();}
   // return commission rate
   public double getCommissionRate() {return cE.getCommissionRate();}
